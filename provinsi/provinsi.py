...
layer = mapnik.Layer('m_habibi_04315004-2')
layer.datasource = ds 
layer.styles.append('My Style')
m.layers.append(layer)
m.zoom_all()
mapnik.render_to_file(m,'m_habibi_04315004-2.png', 'png')
print "rendered image to 'm_habibi_04315004-2.png'"
